...
Baza de date va fi un dictionar in care cheia va fi id-ul task-ului iar valoarea va fi o
instanta a clasei Task.
...
task si apoi o mapeaza in database la cheia id.
